...
- Implement state-based logic for charging, discharging, idle, and fault conditions
...
## Software Used:
- Simulink | Model-based Design and control algorithm simulation
- Embedded C | Core BMS Logic and Control Implementation
- Bazel | Build System for compipling embedded code and managing dependencies
- RTOS | Task scheduling, timing, and real-time behaviour simulation
- Git | Version control and collaborative development
- GitLab CI/CD | Automated build, test and deployment piplines
